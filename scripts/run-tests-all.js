 ...
 * 2) Backend Integration (API) tests (apps/backend: test:integration-api)
...
const groups = [
  ...
  { name: 'Backend Integration (API) tests', cmd: 'npm', args: ['run', 'test:integration-api', '-w', 'apps/backend'] },
